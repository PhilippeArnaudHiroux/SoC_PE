...
typedef struct
{
    ...
    XGpio_Config db08;  /**< Pin for the Display Data8 signal */
    XGpio_Config db09;  /**< Pin for the Display Data9 signal */
    XGpio_Config db10;  /**< Pin for the Display Data10 signal */
    XGpio_Config db11;  /**< Pin for the Display Data11 signal */
    XGpio_Config db12;  /**< Pin for the Display Data12 signal */
    XGpio_Config db13;  /**< Pin for the Display Data13 signal */
    XGpio_Config db14;  /**< Pin for the Display Data14 signal */
    XGpio_Config db15;  /**< Pin for the Display Data15 signal */
    XGpio_Config nrd;   /** Pin for the Display Read signal */
    XGpio_Config nwr;   /** Pin for the Display Write signal */
    XGpio_Config dc;    /** Pin for the Display D/C signal */
    XGpio_Config rst;   /** Pin for the Display Reset signal */
} mtb_st7789v_pins_t;
 ...
 * what went wrong
 */
uint8_t mtb_st7789v_init8(const mtb_st7789v_pins_t *pins);
