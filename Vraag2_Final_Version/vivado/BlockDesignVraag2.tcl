...
proc create_root_design { parentCell } {
  ...
  set IIC_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 -portmaps { \
   SCL_I { physical_name IIC_0_scl_i direction I } \
   SCL_O { physical_name IIC_0_scl_o direction O } \
   SCL_T { physical_name IIC_0_scl_t direction O } \
   SDA_I { physical_name IIC_0_sda_i direction I } \
   SDA_O { physical_name IIC_0_sda_o direction O } \
   SDA_T { physical_name IIC_0_sda_t direction O } \
   } \
  IIC_0 ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports IIC_0]


  # Create ports
  set clk_in1_0 [ create_bd_port -dir I -type clk -freq_hz 125000000 clk_in1_0 ]
  set d_out_0 [ create_bd_port -dir O d_out_0 ]
  set gpo_I2C_RST [ create_bd_port -dir O -from 0 -to 0 gpo_I2C_RST ]

  # Create instance: NeoPixel_0, and set properties
  set block_name NeoPixel
  set block_cell_name NeoPixel_0
  if { [catch {set NeoPixel_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $NeoPixel_0 eq "" } {
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_iic_0/S_AXI] [get_bd_intf_pins axi_smc/M01_AXI]
  ...
  connect_bd_net -net NeoPixel_0_addr [get_bd_pins NeoPixel_0/addr] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net NeoPixel_0_d_out [get_bd_ports d_out_0] [get_bd_pins NeoPixel_0/d_out]
  connect_bd_net -net axi_iic_0_gpo [get_bd_ports gpo_I2C_RST] [get_bd_pins axi_iic_0/gpo]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins NeoPixel_0/clk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins NeoPixel_0/value] [get_bd_pins xlslice_0/Dout]
